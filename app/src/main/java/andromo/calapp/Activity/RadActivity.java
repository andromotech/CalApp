...
public class RadActivity extends AppCompatActivity {
        ...
        appBarLayout.addOnOffsetChangedListener(new AppBarLayout.OnOffsetChangedListener() {
            ...
            public void onOffsetChanged(AppBarLayout appBarLayout, int verticalOffset) {
                ...
                if (scrollRange + verticalOffset == 0) {
                    collapsingToolbar.setTitle("ଅସଲି ଖଡିରତ୍ନ ପଞ୍ଜିକା");
    ...
    private void initViews(){
        ...
        pd.setMessage("Fetching Odia Calendar...");
        pd.setCancelable(true);
        recyclerView = (RecyclerView) findViewById(R.id.recycler_view);

        RadhaList = new ArrayList<>();
        adapter = new RadhaRamanAdp(this, RadhaList);//araay OFMJsonData
    ...
    private void loadJSON1(){
        try{
            ...
            Call<RaMView> call = apiServer.getRadhaCal();
            call.enqueue(new Callback<RaMView>() {
                @Override
                public void onResponse(Call<RaMView> call, Response<RaMView> response) {
                    List<RaModel> items = response.body().getRadhaCal();
...
//                    pd.hide();
                ...
                @Override
                public void onFailure(Call<RaMView> call, Throwable t) {
                    Log.d("Error", t.getMessage());
                    Toast.makeText(RadActivity.this, "Error Fetching Data!", Toast.LENGTH_SHORT).show();
                    pd.hide();
